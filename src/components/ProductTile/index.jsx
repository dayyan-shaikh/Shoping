...
function ProductTile({ singleProductTile }) {
    ...
    function handleNavigate(getCurrentProductId){
  ...
  return (
    <div className="relative group border border-cyan-700 p-6 cursor-pointer">
      ...
      <button onClick={() => handleNavigate(singleProductTile.id)} className="px-5 mt-5 py-2 w-full cursor-pointer rounded-none bg-black text-white text-lg">View Details</button>
    </div>
  );
}
